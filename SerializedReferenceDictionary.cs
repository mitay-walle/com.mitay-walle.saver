...
namespace Saving
{
	...
	/// </example>
	[Serializable]
	public class SerializedReferenceDictionary<K, V> : SerializedReferenceDictionary<K, V, K, V>
	{
		/// <summary>
	...
	[Serializable]
	public abstract class SerializedReferenceDictionary<K, V, SK, SV> : Dictionary<K, V>, ISerializationCallbackReceiver
	{
